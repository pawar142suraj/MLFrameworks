...
def get_ds(config):
    ...
    train_dataloader = DataLoader(train_ds, batch_size=config['batch_size'], shuffle=True, collate_fn=train_ds.collate_fn)
    val_dataloader = DataLoader(val_ds, batch_size=config['batch_size'], shuffle=False, collate_fn=val_ds.collate_fn)
